...
describe('NextcloudPage', () => {
  let fixture: ComponentFixture<NextcloudPage>;
  let component: NextcloudPage;
  let productServiceMock: { getProductTiers: ReturnType<typeof vi.fn> };

  const mockProducts: NextcloudProduct[] = [
    { productID: '1', name: 'Nextcloud Basic', storageAmount: 2, storageUnit: 'TB', trialDays: 14, pricePerMonth: 9.99 },
    { productID: '2', name: 'Nextcloud Pro', storageAmount: 4, storageUnit: 'TB', trialDays: 14, pricePerMonth: 14.99 }
  ];
  ...
  beforeEach(async () => {
    ...
    await TestBed.configureTestingModule({
      // NextcloudComponent is standalone and already declares its own template
    ...
    fixture = TestBed.createComponent(NextcloudPage);
  ...
  it('should move to Success and expose the returned products once the request resolves', async () => {
    ...
    expect(component.nextcloudProducts()).toEqual(mockProducts);
  });
