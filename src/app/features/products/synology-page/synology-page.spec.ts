...
describe('SynologyPage', () => {
  let fixture: ComponentFixture<SynologyPage>;
  let component: SynologyPage;
  ...
  beforeEach(async () => {
    ...
    fixture = TestBed.createComponent(SynologyPage);
