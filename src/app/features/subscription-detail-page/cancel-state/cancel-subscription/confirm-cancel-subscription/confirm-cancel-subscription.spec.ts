...
import { ConfirmCancelSubscription } from './confirm-cancel-subscription';

const mockDialogRef = { close: vi.fn() };

describe('ConfirmCancelSubscription', () => {
  let component: ConfirmCancelSubscription;
  let fixture:   ComponentFixture<ConfirmCancelSubscription>;

  beforeEach(async () => {
    vi.clearAllMocks();

    await TestBed.configureTestingModule({
      imports: [ConfirmCancelSubscription],
      providers: [
        { provide: MatDialogRef, useValue: mockDialogRef },
      ],
    }).compileComponents();

    fixture   = TestBed.createComponent(ConfirmCancelSubscription);
