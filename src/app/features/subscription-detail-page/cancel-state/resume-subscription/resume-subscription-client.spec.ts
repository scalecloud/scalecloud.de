...
describe('ResumeSubscriptionClient', () => {
  let resumeSubscriptionClient: ResumeSubscriptionClient;
  ...
  beforeEach(() => {
    ...
    resumeSubscriptionClient = TestBed.inject(ResumeSubscriptionClient);
  ...
  it('should be created', () => {
    expect(resumeSubscriptionClient).toBeTruthy();
  });

  describe('resumeSubscription()', () => {
    it('POSTs to the correct URL with the request body', () => {
      resumeSubscriptionClient.resumeSubscription(MOCK_REQUEST).subscribe();
    ...
    it('emits the reply returned by the API', () => {
      ...
      resumeSubscriptionClient.resumeSubscription(MOCK_REQUEST).subscribe((reply) => (result = reply));
