...
describe('SubscriptionDetailCard', () => {
  let component: SubscriptionDetailCard;
  ...
  async function setup(options: {
    ...
    .overrideComponent(CancelState, { set: { template: '', imports: [], providers: [] } })
    .compileComponents();

    fixture = TestBed.createComponent(SubscriptionDetailCard);
  ...
  it('sets serviceStatus to Error when the API call fails', async () => {
    await setup();
    subscriptionDetailCardClient.getSubscriptionDetail.mockReturnValue(
  ...
  it('reloads subscription data and updates reply on success', async () => {
    ...
    subscriptionDetailCardClient.getSubscriptionDetail.mockReturnValue(of(second));
